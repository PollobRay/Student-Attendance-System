...
public class ViewDayAttendance extends JFrame
{
   
    protected JLabel grp,grpd,tec,sem,semd,tecd,total,totald,back,save,date,dated,biit,totalp,totalpd;
  private Font font;
  private Container c;
   private Cursor cursor;
    private ImageIcon b,icon,savei,biiti;
     String []columns={"Roll","Name","Attendance"};
	...
	Image sv=sav.getScaledInstance(250, 50, Image.SCALE_SMOOTH);
       ...
       save.setToolTipText("SAVE AS PDF");
        ...
        tec.setBounds(500, 40, 200, 50);
        tec.setFont(font);
        tec.setForeground(Color.BLUE);
        c.add(tec);
        
        tecd=new JLabel();
        tecd.setBounds(700, 40, 300, 50);
        tecd.setFont(font);
        c.add(tecd);
      ...
      sem.setBounds(500,70,200,50);
      sem.setFont(font);
      sem.setForeground(Color.BLUE);
      c.add(sem);
      
      semd=new JLabel();
      semd.setBounds(700,70,100,50);
      semd.setFont(font);
      c.add(semd);
      
        //      group
      grp=new JLabel("Group              :");
      grp.setBounds(500,100,200,50);
      grp.setFont(font);
      grp.setForeground(Color.BLUE);
      c.add(grp);
      
      grpd=new JLabel();
      grpd.setBounds(700,100,100,50);
      grpd.setFont(font);
      c.add(grpd);
      
      //        total student
      total=new JLabel("Total Students :");
      total.setBounds(500,130,200,50);
      total.setFont(font);
      total.setForeground(Color.BLUE);
      c.add(total);
      
      totald=new JLabel();
      totald.setBounds(700,130,100,50);
      totald.setFont(font);
      c.add(totald);
      // total present
      totalp=new JLabel("Total Present   :");
      totalp.setBounds(500,160,200,50);
      totalp.setFont(font);
      totalp.setForeground(Color.BLUE);
      c.add(totalp);
      
      totalpd=new JLabel();
      totalpd.setBounds(700,160,200,50);
      totalpd.setFont(font);
      c.add(totalpd);
       //       date
      date=new JLabel("Date                 :");
      date.setBounds(500,190,200,50);
      date.setFont(font);
      date.setForeground(Color.BLUE);
      c.add(date);
      
      dated=new JLabel();
      dated.setBounds(700,190,200,50);
      dated.setFont(font);
      c.add(dated);
   ...
   class Handler implements MouseListener
    {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getSource()==save)
                {
                   ...
                   JFileChooser c = new JFileChooser();
                    ...
                    int rVal = c.showSaveDialog(ViewDayAttendance.this);
       ...
       document.add(new Paragraph("                                                     Day Report",FontFactory.getFont(FontFactory.TIMES_BOLD,18,com.itextpdf.text.Font.BOLD,BaseColor.RED)));
       ...
       document.add(new Paragraph("                                                   Total Present      : "+" "+totalpd.getText()));
       document.add(new Paragraph("                                                   Date                    : "+" "+dated.getText()));
       //document.add(new Paragraph("                                             "));
       //document.add(new Paragraph("                                             "));
    ...
    public static void main(String[] args) {
        ...
        ViewDayAttendance vdt=new ViewDayAttendance();
        vdt.setVisible(true);
    }
*/
}
